                ...
                <table id="myTable" class="table table-striped table-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="align-items-center">
                            ...
                            <td class="text-center text-red"><small> <i class="bi bi-calendar2-check-fill"></i> {{ \Carbon\Carbon::parse($location["next_loyer_date"])->locale('fr')->isoFormat('D MMMM YYYY') }}</small> ({{ $location->pre_paye?"pre":"post" }}) </td>
                            {{-- <td class="text-center">
